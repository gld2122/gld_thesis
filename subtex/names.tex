...
assign linguistic tokens for reference to specific individuals
\parencite{alford88}. Article Seven of the Convention on the Rights of the Child
codifies a person's fundamental right to a name: "The child shall be registered
immediately after birth and shall have the right from birth to a name."
\parencite{crc}

\subsection{Functions of a Name}

Why do people give people names? Let's divide the functions of names into
