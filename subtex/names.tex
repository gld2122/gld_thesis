...
Nearly all human beings have at least one name. Article Seven of the Convention
on the Rights of the Child codifies a person's fundamental right to a name: "The
...
Why do people have names? We will divide the functions of names into
\textit{reference} and \textit{symbolic} functions, which categories we will
further subdivide below.
